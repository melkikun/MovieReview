...
public class HorizontalAuthorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<String> list = new ArrayList<>();
    private Context context;
    private final String IMG = "https://image.tmdb.org/t/p/w500";

    public HorizontalAuthorAdapter(List<String> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (list.size() == 0){
            dataHolder.img_trailer.setImageResource(R.drawable.no_image);
        }else{
